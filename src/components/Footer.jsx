    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="bg-primary-dark text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-10 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <Link
            to="/contact"
            className="inline-flex items-center justify-center gap-2 bg-white text-primary-dark px-6 py-3.5 rounded-lg font-semibold hover:bg-gray-100 active:bg-gray-200 transition-colors shrink-0 min-h-[48px] w-full sm:w-auto"
          >
            Get a Quote
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
          ...
          <div>
            ...
            <ul className="space-y-1 sm:space-y-2">
              {categories.length === 0 && <li className="text-sm text-gray-500">Categories load from your catalog.</li>}
              {categories.map((cat) => (
                <li key={cat.id}>
                  <Link
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-2 hover:text-white active:text-white/90 transition-colors py-1.5 -my-1.5"
                >
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-2 hover:text-white active:text-white/90 transition-colors py-1.5 -my-1.5 break-all"
                >
              ...
              {Object.entries(siteData.social).map(([key, url]) => {
                ...
                return (
                  <a
                    ...
                    className="p-3 rounded-lg bg-gray-800 hover:bg-primary hover:text-white active:bg-primary-dark transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center"
                    aria-label={key}
                  >
